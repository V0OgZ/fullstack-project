# 🌀 GRUT RÉVÉLATION COMPLÈTE - PARTIE 2 : GÉOMÉTRIE NON-EUCLIDIENNE 🌀
...
### 🗺️ **NOUVELLE ARCHITECTURE : MONDE → MAP → SCÉNARIO**
...
#### 3. **Heroes Scenario Format (.hscenario)**
```json
{
...
**GRUT demande la réorganisation :**
