...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: ['**/debug*.spec.ts', '**/terrain-vision*.spec.ts', '**/turn-zfc-test.spec.ts', '**/simple-turn-test.spec.ts', '**/quick-verification.spec.ts', '**/epic-content-demo.spec.ts', '**/fullscreen-demo.spec.ts', '**/script-tester-demo.spec.ts'],
    },
  ],
}); 