...
echo ""
echo -e "${BLUE}📚 Documentation: 🖥️ backend/src/main/resources/quantum-creatures.json${NC}"
echo -e "${BLUE}🎮 Service: 🖥️ backend/src/main/java/com/heroesoftimepoc/temporalengine/service/CreatureService.java${NC}"
