...
if [ -f "🖥️ backend/src/main/java/com/example/demo/controller/StoryModeController.java" ]; then
    echo "Scénarios référencés dans StoryModeController :"
    grep -o '"[^"]*\.hots"' 🖥️ backend/src/main/java/com/example/demo/controller/StoryModeController.java | sort | uniq
else
