...
echo "📁 FICHIERS CRÉÉS :"
echo "📄 🖥️ backend/src/main/resources/heroes/grofi/Hawkeye.json"
echo "📄 🎮 game_assets/scenarios/hots/scenario_pieds_nickeles_hawkeye_opticon.hots"
echo "📄 ⚙️ scripts/test-scenario-pieds-nickeles-hawkeye.sh"
...
echo "4. Dans un autre terminal : ./⚙️ scripts/test-scenario-pieds-nickeles-hawkeye.sh"
echo ""
