# 🌟 **HEROES OF TIME - LORE DU DÉVELOPPEMENT**
...
- **Loup Temporel** - Première créature d'entraînement
...
### **L'Impact sur le Développement de Jeux**
...
- **`scripts/test/test-scenarios-debutants.sh`** - Tests des scénarios débutants
