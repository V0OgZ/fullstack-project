...
CLASSIC_TESTS=(
    ...
    "causality-wall:./⚙️ scripts/test-causality-wall.sh:180:Causality Wall Test"
    "vision-temporelle:./⚙️ scripts/test-vision-temporelle.sh:120:Vision Temporelle Test"
    "quantum-maze:./⚙️ scripts/test-quantum-maze-complete.sh:240:Quantum Maze Complete"
    "test-final-mega:./⚙️ scripts/test-complet-final.sh:600:Test Final Mega (10min max)"
    "ui-quick:./⚙️ scripts/actifs/test-ui-quick.sh:90:UI Quick Test"
    "stress-test:./⚙️ scripts/test/temporal-stress-test.sh:300:Temporal Stress Test"
)

# Nouveaux tests JSON avec surveillance Vince Vega
JSON_TESTS=(
    "json-panopticon:./⚙️ scripts/test-panopticon-json-scenario.sh:180:JSON Panopticon Scenario"
    "json-duel-collapse:./⚙️ scripts/test-duel-collapse-json.sh:120:JSON Duel Collapse"
    "json-runner-test:./⚙️ scripts/test-json-scenario-runner.sh GROFI_QUICK_TEST:150:JSON Runner Test"
)
