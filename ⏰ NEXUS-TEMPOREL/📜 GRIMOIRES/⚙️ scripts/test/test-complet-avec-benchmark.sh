...
files_to_check=(
    ...
    "🖥️ backend/src/main/java/com/heroesoftimepoc/temporalengine/service/NativeScenarioService.java"
    "🖥️ backend/src/main/java/com/heroesoftimepoc/temporalengine/controller/BenchmarkController.java"
)
