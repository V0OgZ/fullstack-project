        ...
        "backend_updates": [
            {
                ...
                "file": "🖥️ backend/src/main/java/com/example/demo/model/World.java",
                "changes": "Add String worldFormula field",
                "priority": 3
            },
            {
                "task": "Implémenter Π operator dans parser",
                "file": "🖥️ backend/src/main/java/com/example/demo/parser/TemporalScriptParser.java",
                "changes": "Add PI_OPERATOR token and parsing logic",
                "priority": 3
            },
            {
                "task": "Créer ProjectionEngine",
                "file": "🖥️ backend/src/main/java/com/example/demo/engine/ProjectionEngine.java",
