...
2. **Ouvrez le dashboard** : http://localhost:9000

3. **Jouez** ! Commencez par l'interface temporelle sur http://localhost:5174
...
Pour les détails techniques et guides avancés :
...
*"Le temps n'est qu'une illusion. La causalité, un défi à relever."* - Jean Grofignon, Héros Légendaire 