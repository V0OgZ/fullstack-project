...
/**
 * Service LEGACY pour gérer la décroissance temporelle dans Heroes of Time
 * 
 * ANCIEN SYSTÈME : Anna the Martopicker - Version Timeline-Based
 * 
 ...
 * 
 * MÉCANIQUES LEGACY :
 * 1. Décroissance des bâtiments pour joueurs en retard (timeline-based)
 * 2. Effets de superposition excessive
 * 3. Avantages pour les objets de vision future
 * 
 * @deprecated Utiliser TemporalDecayServiceDK20 pour les nouvelles fonctionnalités
 */
